<?php $__env->startSection('title', 'Transaksi Penjualan Baru'); ?>
...
<div class="row g-4">
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-3 overflow-auto style-scroll p-1" style="max-height: 520px;" id="produkContainer">
                    <?php $__empty_1 = true; $__currentLoopData = $produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <div class="col-md-4 col-6 produk-item" data-nama="<?php echo e(strtolower($namaProduk)); ?>">
                            <div class="card produk-card p-3 text-center h-100" 
                                 onclick="addToCart(<?php echo e($item->id); ?>, '<?php echo e(addslashes($namaProduk)); ?>', <?php echo e($hargaProduk); ?>, <?php echo e($stokProduk); ?>)">
                                <div class="fw-bold text-white text-truncate"><?php echo e($namaProduk); ?></div>
                                <div class="small text-warning fw-semibold mt-1">Rp <?php echo e(number_format($hargaProduk, 0, ',', '.')); ?></div>
                                <div class="small text-white-50 mt-1">Stok: <?php echo e($stokProduk); ?></div>
                            </div>
                        </div>
    ...
    <div class="col-lg-5">
        <form action="<?php echo e(route('penjualan.store')); ?>" method="POST" id="formTransaksi" onsubmit="return validateCheckout()">
            <?php echo csrf_field(); ?>
            <div class="card create-card-main border-0 shadow-lg">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex gap-2">
                        <a href="<?php echo e(route('penjualan.index')); ?>" class="btn btn-outline-secondary px-4 rounded-3 text-white border-secondary">Kembali</a>
        ...
        <div class="modal-content create-card-main text-white" style="background: rgba(22, 27, 34, 0.95) !important;">
            ...
            <div class="modal-body text-center p-4">
                ...
                <div class="bg-white p-3 d-inline-block rounded-3 my-2 shadow">
                    <img src="<?php echo e(asset('images/qris.png')); ?>" alt="QRIS Code" class="img-fluid" style="max-width: 240px;" onerror="this.onerror=null; this.src='https://api.qrserver.com/v1/create-qr-code/?size=240x240&data=QRIS_DEMO';">
                </div>
                <div class="mt-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\POS_Anzz100-main\resources\views/penjualan/create.blade.php ENDPATH**/ ?>