...
<div class="login-card">
    ...
    <form action="<?php echo e(route('login')); ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control input-dark rounded-3 <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-4">
            ...
            <input type="password" name="password" class="form-control input-dark rounded-3 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</html><?php /**PATH C:\laragon\www\POS_Anzz100-main\resources\views/login.blade.php ENDPATH**/ ?>