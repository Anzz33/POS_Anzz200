...
<div class="card penjualan-card-main border-0 shadow-lg overflow-hidden">
    <div class="card-body p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-secondary border-opacity-25">
            ...
            <div>
                <a href="<?php echo e(route('penjualan.create')); ?>" class="btn btn-warning text-dark fw-bold px-4 py-2 rounded-3 shadow-sm d-inline-flex align-items-center gap-2">
                    + Transaksi Baru
                </a>
            </div>
        </div>
        ...
        <div class="penjualan-card-inner p-3 mb-4">
            <form action="<?php echo e(route('penjualan.index')); ?>" method="GET" class="row g-2 align-items-center">
                <div class="col-md-4 col-12">
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control input-dark rounded-3" placeholder="Cari kasir / pelanggan...">
                </div>
                <div class="col-auto">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $penjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="text-center fw-semibold" style="color: #a0aec0 !important;">
                                <?php echo e(method_exists($penjualan, 'firstItem') ? $penjualan->firstItem() + $index : $index + 1); ?>
                            ...
                            <td class="fw-semibold text-white">
                                <?php echo e($item->user->name ?? $item->kasir ?? '-'); ?>

                            </td>
                            <td>
                                <?php echo e($item->pelanggan ?? 'Pelanggan Umum'); ?>
                            ...
                            <td class="text-center">
                                ...
                                ?>
                                <?php if(str_contains($metode, 'CASH') || str_contains($metode, 'TUNAI')): ?>
                                    <span class="badge badge-cash px-3 py-2 rounded-pill fw-semibold fs-8"><?php echo e($metode); ?></span>
                                <?php elseif(str_contains($metode, 'TRANSFER')): ?>
                                    <span class="badge badge-transfer px-3 py-2 rounded-pill fw-semibold fs-8"><?php echo e($metode); ?></span>
                                <?php else: ?>
                                    <span class="badge badge-qris px-3 py-2 rounded-pill fw-semibold fs-8"><?php echo e($metode); ?></span>
                                <?php endif; ?>
                            </td>
                            <td class="text-end fw-bold text-warning">
                                Rp <?php echo e(number_format($item->total_harga ?? $item->total_pembayaran ?? $item->total ?? 0, 0, ',', '.')); ?>
        ...
        <!-- Pagination -->
        <?php if(method_exists($penjualan, 'links')): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\POS_Anzz100-main\resources\views/penjualan/index.blade.php ENDPATH**/ ?>