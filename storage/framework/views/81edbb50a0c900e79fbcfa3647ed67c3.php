    ...
    <div class="card-body p-4">
        ...
        <form action="<?php echo e(route('produk.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nama" class="form-control input-dark rounded-3" placeholder="Masukkan nama produk" value="<?php echo e(old('nama')); ?>" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="jenis_id" class="form-select input-dark rounded-3" required>
                                    ...
                                    <?php if(isset($jenis)): ?>
                                        <?php $__currentLoopData = $jenis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($j->id); ?>" <?php echo e(old('jenis_id') == $j->id ? 'selected' : ''); ?>>
                                                <?php echo e($j->nama_jenis ?? $j->nama); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="harga_beli" class="form-control input-dark rounded-end-3 border-start-0" value="<?php echo e(old('harga_beli', 0)); ?>" min="0" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text input-dark border-end-0 text-white-50">Rp</span>
                                    <input type="number" name="harga_jual" class="form-control input-dark rounded-end-3 border-start-0" value="<?php echo e(old('harga_jual', 0)); ?>" min="0" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="number" name="stok" class="form-control input-dark rounded-3" value="<?php echo e(old('stok', 0)); ?>" min="0" required>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="<?php echo e(route('produk.index')); ?>" class="btn btn-outline-secondary px-4 rounded-3 text-white border-secondary">
                    &larr; Kembali
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\POS_Anzz100-main\resources\views/produk/create.blade.php ENDPATH**/ ?>