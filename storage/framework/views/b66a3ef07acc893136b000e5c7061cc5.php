...
<div class="card card-tentang-utama text-white border-0 shadow-lg overflow-hidden">
    <div class="card-body p-4">
        ...
        <form action="<?php echo e(route('tentang.update')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="card-tentang-inner p-4 text-center">
                    ...
                    <div class="d-flex flex-column align-items-center">
                        <div id="imagePreviewBox" 
                            ...
                            <img id="imagePreview" 
                                 src="<?php echo e(Auth::user()->foto ? asset('storage/' . Auth::user()->foto) : asset('img/profil.jpg')); ?>" 
                                 alt="Foto Profil" 
                                 class="w-100 h-100 object-fit-cover <?php echo e(Auth::user()->foto || file_exists(public_path('img/profil.jpg')) ? '' : 'd-none'); ?>">

                            <div id="uploadPlaceholder" class="text-center p-2 <?php echo e(Auth::user()->foto || file_exists(public_path('img/profil.jpg')) ? 'd-none' : ''); ?>">
                        ...
                        <h4 class="fw-bold text-white mb-2"><?php echo e(Auth::user()->name ?? 'Nama Pengguna'); ?></h4>
                    ...
                    <div class="col-md-6">
                        <div class="card-tentang-inner p-4 h-100" style="border-left: 4px solid #d4af37 !important;">
                            ...
                            <ul class="list-unstyled mb-0 small text-white-50">
                                <li class="mb-2">
                                    <i class="bi bi-envelope-fill text-danger me-2"></i><strong class="text-white">Email:</strong> <?php echo e(Auth::user()->email ?? 'email@example.com'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\POS_Anzz100-main\resources\views/tentang/index.blade.php ENDPATH**/ ?>