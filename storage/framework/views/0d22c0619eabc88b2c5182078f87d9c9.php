        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-secondary border-opacity-25">
            <div>
                ...
                <p class="mb-0 small text-white-50">
                    Selamat Datang, <span class="text-white fw-semibold"><?php echo e(Auth::user()->name ?? 'User'); ?></span> 
                    &bull; <?php echo e(\Carbon\Carbon::now()->translatedFormat('l, d F Y')); ?> 
                    &bull; <?php echo e(\Carbon\Carbon::now()->format('H:i')); ?> WIB
                </p>
            </div>
            <div>
                <a href="<?php echo e(route('penjualan.create') ?? '#'); ?>" class="btn btn-warning text-dark fw-bold px-3 py-2 rounded-3 shadow-sm d-inline-flex align-items-center gap-2" style="font-size: 0.85rem;">
            ...
            <div class="col-md-3">
                <div class="stat-box p-3 d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold text-white mb-0">Rp <?php echo e(number_format($totalPenjualan ?? 4306000, 0, ',', '.')); ?></h4>
                    </div>
                    <div class="stat-icon">
            ...
            <div class="col-md-3">
                <div class="stat-box p-3 d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold text-white mb-0"><?php echo e($totalTransaksi ?? 23); ?></h4>
                    </div>
                    <div class="stat-icon">
            ...
            <div class="col-md-3">
                <div class="stat-box p-3 d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold text-white mb-0">Rp <?php echo e(number_format($pembayaranCash ?? 1273000, 0, ',', '.')); ?></h4>
                    </div>
                    <div class="stat-icon">
            ...
            <div class="col-md-3">
                <div class="stat-box p-3 d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h4 class="fw-bold text-white mb-0">Rp <?php echo e(number_format($nonTunai ?? 3033000, 0, ',', '.')); ?></h4>
                    </div>
                    <div class="stat-icon">
                ...
                <div class="dash-box p-3 h-100">
                    ...
                    <div class="table-responsive">
                        <table class="table table-dash mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $stokRendah ?? [
                                ...
                                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td><?php echo e($index + 1); ?></td>
                                        <td class="fw-semibold text-white"><?php echo e($item->nama_produk ?? $item->nama); ?></td>
                                        <td class="text-end">
                                            <span class="badge bg-warning bg-opacity-25 text-warning border border-warning border-opacity-25 px-2 py-1">
                                                <?php echo e($item->stok); ?> Pcs
                                            </span>
                                        </td>
                                    </tr>
                ...
                <div class="dash-box p-3 h-100">
                    ...
                    <div class="table-responsive">
                        <table class="table table-dash mb-0">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $produkHabis ?? [
        ...
        <div class="dash-box p-3">
            ...
            <div class="table-responsive">
                <table class="table table-dash mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $bestSeller ?? [
                            ...
                            <tr>
                                <td>
                                    <span class="rank-badge <?php echo e($index == 0 ? 'rank-1' : ($index == 1 ? 'rank-2' : ($index == 2 ? 'rank-3' : 'rank-other'))); ?>">
                                        <?php echo e($index + 1); ?>

                                    </span>
                                </td>
                                <td class="fw-semibold text-white"><?php echo e($item->nama_produk ?? $item->nama); ?></td>
                                <td class="text-center text-white-50"><?php echo e($item->stok); ?> Pcs</td>
                                <td class="text-end fw-bold text-warning"><?php echo e($item->total_terjual ?? $item->terjual ?? 0); ?> terjual</td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\POS_Anzz100-main\resources\views/dashboard.blade.php ENDPATH**/ ?>